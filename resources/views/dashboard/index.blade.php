...
@section('title', 'PUPR Jember - Dashboard')
@section('title_header', 'Dashboard PUPR')
@section('subtitle_header', \Carbon\Carbon::now()->translatedFormat('l, d F Y') . ' - Selamat datang, Admin Dinas PUPR Jember')
...
@section('content')
    ...
    <!-- Greeting -->
    <div class="greeting">
        <h1>Halo, <span>Admin PUPR!</span></h1>
        <p>Ringkasan pelaksanaan kegiatan dan survei proyek Dinas PUPR Kabupaten Jember.</p>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-label">BAP Terbit</div>
                <div class="stat-change up">
                    <i class="fas fa-print"></i> Dokumen Resmi BAP
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="chart-section">
        ...
        <div class="chart-card">
            <div class="card-header">
                <h3><i class="fas fa-chart-line" style="color:var(--primary);margin-right:10px;"></i>Progres Kegiatan (7 Hari)</h3>
                <a href="{{ url('/data-mingguan') }}" class="card-action">Detail <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="card-body">
        ...
        <div class="chart-card">
            <div class="card-header">
                <h3><i class="fas fa-chart-pie" style="color:var(--secondary);margin-right:10px;"></i>Status Kegiatan</h3>
                <span style="font-size:12px;color:var(--text-muted);">Total: {{ $totalKegiatan }} kegiatan</span>
            </div>
            <div class="card-body">
    ...
    <div class="pipeline-section">
        <div class="section-header">
            <h3><i class="fas fa-stream" style="color:var(--primary);margin-right:10px;"></i>Pipeline Kegiatan</h3>
            <a href="{{ url('/data-mingguan') }}" class="view-all">Lihat semua <i class="fas fa-arrow-right"></i></a>
        </div>
        <div class="pipeline-steps">
            <div class="pipeline-step">
                <div class="step-icon blue"><i class="fas fa-file-alt"></i></div>
                <div class="step-count">{{ $pipeline['menunggu'] }}</div>
                <div class="step-label">Perencanaan</div>
                <div class="step-progress"><div class="step-fill blue" style="width:100%;"></div></div>
            </div>
            <div class="pipeline-step">
                <div class="step-icon orange"><i class="fas fa-hard-hat"></i></div>
            ...
            <div class="pipeline-step">
                <div class="step-icon green"><i class="fas fa-file-pdf"></i></div>
                <div class="step-count">{{ $pipeline['bap'] }}</div>
                <div class="step-label">BAP Selesai</div>
    ...
    <div class="dashboard-grid">
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-calendar-week" style="color:var(--primary);margin-right:10px;"></i>Data Kegiatan Terbaru</h3>
                    <a href="{{ url('/data-mingguan/create') }}" class="card-action">Input Data <i class="fas fa-plus-circle"></i></a>
                </div>
                <div class="card-body">
                    ...
                    @forelse($recentActivities as $log)
                        ...
                        <div class="brief-item">
                            ...
                            <div class="brief-info">
                                <div class="brief-title">{{ $log->nama_kegiatan ?: ($log->dataMingguan->nama_kegiatan ?? 'Survei Lapangan') }}</div>
                                <div class="brief-meta">
                                    <span><i class="fas fa-user"></i> {{ $petugasName }}</span>
                                    <span><i class="fas fa-location-dot"></i> Kec. {{ ucwords(str_replace('_',' ', $log->kecamatan ?: ($log->dataMingguan->lokasi ?? ''))) }}</span>
                                    <span class="tag"><i class="fas fa-check-circle" style="color:var(--success);"></i> Survei Selesai</span>
                                </div>
                            </div>
                            <div class="brief-action">
                                ...
                                @if($log->data_mingguan_id)
                                    <a href="{{ url('/cetak-bap/' . $log->data_mingguan_id) }}" target="_blank" class="btn-reject" style="text-decoration:none;" title="Cetak BAP"><i class="fas fa-file-pdf"></i></a>
                                @endif
                            </div>
                        </div>
                    @empty
                    ...
                    @forelse($recentActivities as $log)
                        ...
                        <div class="activity-item">
                            ...
                            <div class="activity-content">
                                <div class="activity-text"><strong>{{ $petugasName }}</strong> menyelesai survei {{ $log->nama_kegiatan ?: ($log->dataMingguan->nama_kegiatan ?? 'Kegiatan') }}</div>
                                <div class="activity-time">{{ $log->updated_at ? $log->updated_at->diffForHumans() : '-' }}</div>
                            </div>
                        </div>
                    @empty
                        <div class="activity-item">
